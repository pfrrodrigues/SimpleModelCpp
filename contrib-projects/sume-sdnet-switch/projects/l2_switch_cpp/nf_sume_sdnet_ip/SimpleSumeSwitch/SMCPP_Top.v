...
SMCPP_Top_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
SMCPP_Top_AXILiteS_s_axi_U(
...
always @ (*) begin
    if (((m_axis_TREADY_V_read_read_fu_173_p2 == 1'd0) & (s_axis_TVALID_V_read_read_fu_124_p2 == 1'd1))) begin
        ap_phi_mux_storemerge_phi_fu_196_p6 = 1'd0;
    end else if (((s_axis_TVALID_V_read_read_fu_124_p2 == 1'd0) | ((s_axis_TVALID_V_read_read_fu_124_p2 == 1'd1) & (m_axis_TREADY_V_read_read_fu_173_p2 == 1'd1)))) begin
...
always @ (*) begin
    if ((s_axis_TVALID_V_read_read_fu_124_p2 == 1'd1)) begin
        m_axis_TVALID_V = 1'd1;
    end else if ((s_axis_TVALID_V_read_read_fu_124_p2 == 1'd0)) begin
        m_axis_TVALID_V = 1'd0;
    end else begin
        m_axis_TVALID_V = 'bx;
    end
end
...
assign m_axis_TLAST_V = s_axis_TLAST_V;

assign m_axis_TREADY_V_read_read_fu_173_p2 = m_axis_TREADY_V;

assign s_axis_TREADY_V = ap_phi_mux_storemerge_phi_fu_196_p6;

assign s_axis_TVALID_V_read_read_fu_124_p2 = s_axis_TVALID_V;
