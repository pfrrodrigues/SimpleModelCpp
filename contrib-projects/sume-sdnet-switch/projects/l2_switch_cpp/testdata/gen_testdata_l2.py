...
DEF_PKT_NUM = 4    # default number of packets to simulation
...
vlan_id_map = {"nf0":0, "nf1":0, "nf2":1, "nf3":1}
...
MAC_addr_H[nf_id_map["nf3"]] = "FF:FF:FF:FF:FF:FF"
...
for time in range(DEF_PKT_NUM):
    ...
    sport = 5056
    dport = 2021 # get_rand_port()
    pkt = Ether(src=src_MAC, dst=dst_MAC) / IP(src=src_IP, dst=dst_IP, ttl=20)
